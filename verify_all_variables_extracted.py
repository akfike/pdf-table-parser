...
text_file_path = 'nsumhss_variables.txt'  # Path to your text file with variables
csv_file_path = 'csvs/clean_csvs/nsumhss_2022_codebook.csv'  # Path to your CSV file
